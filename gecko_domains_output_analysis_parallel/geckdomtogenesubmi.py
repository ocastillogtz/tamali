...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 6:
        ...
        print "The path of a .cluster file is: " + target_directory_path_2
        ...
        cluster_file_number = sys.argv[5]
        print "The cluster file number is: " + cluster_file_number
    else:
        print "Argument 1: You must provide the directory path which contains the gck files"
        print "Argument 2: You must provide the cluster file path"
    ...
    summary_output_name = output_file_name + "_summary.part_" + str(cluster_file_number)
    ...
    ####make it for one cluster file
    ####we need a number from the enumeration of the clusters in the folder
    #### in here file_path will be the input path from the second argument



    file_path = target_directory_path_2
    ref_clust_id = cluster_file_number
                        ...
                        if int(item[0]) == int(gn_file_number):
                            ...
                            if len(computed_clust) > 2:
                                ...
                                if jacindx > 0.0:
                                    ...
                                    #print "this is getting into the file:\n"
                                    print otha_genm_list
                                    #raw_input()
                                    output_file_pointer_2.write(
                                        ...
                                        str(other_genomes_w_findings),str(cluster_stuff[1].strip("\n"))))
